...
const virtualIdentityCases = [
  ...
  { no:'02', label:'少女暴君 / THE GIRL TYRANT', meta:'2026.01.17 · CLIENT PUBLICATION', image:'/assets/virtual-identities/tyrant-cover.jpg', link:'#series/02', alt:'少女暴君，网络发表图片与数据' },
]
