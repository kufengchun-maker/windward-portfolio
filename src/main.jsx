...
const projects = [
  ...
  { id:'virtual', no: '04', title: 'VIRTUAL IDENTITIES', type: 'Virtual photography / 2024—2026', className: 'project--black', note: '面向角色、服装与世界观的付费游戏摄影委托，探索数字身份与幻想叙事。', role: '构图 / 场景 / 光线 / 后期', evidence: '首个案例《花》· 2025.11.13 · 212 喜欢 / 17 评论 / 6 收藏', time:'2024—2026', learned:'练习根据客户角色、服装、世界观与情绪需求，建立角色肖像与杂志式构图语言。', outcome:'完成多个付费委托；首个案例《花》获得 212 喜欢、17 条评论与 6 次收藏。' },
