...
const projects = [
  ...
  { id:'feminism', no: '02', title: 'VIDEO EDITING & PRODUCTION', type: 'Two-film case archive', className: 'project--paper', note: '两项从研究、组织到剪辑与交付的影像实践。', role: '项目策划 / 影像剪辑 / 内容统筹', evidence: 'FEMINISM IN TRANSLATION · GREATER BAY AREA CULTURAL VIDEO', time:'2025—2026', learned:'通过两个项目持续练习研究转译、团队协作与影像叙事。', outcome:'进入案例后可查看两个独立影片项目及其过程材料。' },
  { id:'virtual', no: '03', title: 'VIRTUAL IDENTITIES', type: 'Virtual photography / 2024—2026', className: 'project--black', note: '面向角色、服装与世界观的付费游戏摄影委托，探索数字身份与幻想叙事。', role: '构图 / 场景 / 光线 / 后期', evidence: 'CLIENT PUBLICATIONS / DATA ARCHIVE', time:'2024—2026', learned:'练习根据客户角色、服装、世界观与情绪需求，建立角色肖像与杂志式构图语言。', outcome:'完成多个付费委托；首个案例《花》获得 212 喜欢、17 条评论与 6 次收藏；第二个案例《少女暴君》获得 55 喜欢与 18 条评论；第三个案例《圣诞客单》获得 49 喜欢与 24 条评论。' },
  { id:'shokz', no: '04', title: 'PRODUCT & MARKETING RESEARCH', type: 'Two-case product research archive', className: 'project--paper', note: '将国际市场营销与产品叙事收束为两组课程研究：韶音的日本市场策略，与 Sony 的个人声场视觉提案。', role: '市场研究 / 产品叙事 / 演示表达', evidence: 'SHOKZ IN JAPAN · SONY / PERSONAL SOUND BUBBLE', time:'2025—2026', learned:'练习把市场数据、消费者场景与产品价值转化为清晰、有说服力的视觉表达。', outcome:'进入案例后可查看两个独立的产品与营销研究项目及其演示材料。' },
  { id:'fellowship', no: '05', title: 'ROOTED FUTURES', type: 'Research fellowship / Cross-cultural education', className: 'project--fellowship', note: '将乡村振兴、人工智能时代的传播变革与跨国公益教育，收束为一组持续发生的社会观察与协作实践。', role: '项目参与 / 研究写作 / 课程制作 / 线上教学', evidence: '优秀营员 · 项目证书 · NGO Certificate · 课程论文（未发表）', time:'2025—2026', learned:'在社会议题、研究方法和实际协作之间建立连接，让抽象的文化与传播问题落实为可交付的内容。', outcome:'完成多个研究与教育协作项目，并保留证书、课程材料与论文作为过程证据。' },
]

const videoCaseStudies = [
  { id:'translation', no: '01', title: 'FEMINISM IN TRANSLATION', type: 'Course video / Team leader', className: 'project--paper', note: '讨论语言与翻译如何影响女性形象、身份与话语表达的十分钟影像项目。', role: '主题方向 / 任务分配 / 内容整合 / 最终呈现', evidence: '课程影像项目 · 2026.04.21 发布', url: 'https://b23.tv/89G5F4R', time:'2026.04.21', learned:'在合作中学习如何围绕文化议题建立共同语言，并通过项目管理推进分工与最终呈现。', outcome:'完成约 10 分钟课程视频，讨论语言与翻译如何影响女性形象、身份与话语表达。' },
  { id:'gbaa', no: '02', title: 'GREATER BAY AREA CULTURAL VIDEO', type: 'Team project / Excellence award', className: 'project--green', note: '从文化调研到内容呈现的协作影像；作品《走进大湾区品读 AIGC》获校内优秀奖。', role: '小组组织与领导 / 分工统筹 / 影像剪辑', evidence: '校内优秀奖 · 获奖名单见案例页', time:'2025.06', learned:'学习将文化调研、团队协作与内容呈现连成同一条工作链，并让研究素材真正服务于影像叙事。', outcome:'负责组织、领导和分工，指导两位组员收集文献文本、剪辑所需的图片与视频，并完成最终剪辑；作品《走进大湾区品读 AIGC》获校内优秀奖。' },
]

const productCaseStudies = [
  { id:'shokz-japan', no:'01', title:'SHOKZ IN JAPAN', type:'International Marketing / Final presentation', className:'project--paper', note:'国际市场营销课程期末展示，围绕韶音进入日本市场的文化适配、成功营销案例、财报资料与本土化传播方案展开。', role:'定题 / 国际营销案例研究 / 韶音财报资料查询 / PPT 制作 / 演讲者', evidence:'国际市场营销课程 · 88 / 100', time:'2026.06.11', learned:'将跨文化观察、品牌财报与消费者洞察连成可讲述的市场策略，并在公开表达中建立清晰节奏。', outcome:'作为演讲者全程脱稿完成风趣、生动的期末 presentation；一位组员负责资料查询并协助 PPT 制作。' },
  { id:'sony-bubble', no:'02', title:'SONY / PERSONAL SOUND BUBBLE', type:'Product visual presentation', className:'project--green', note:'围绕 Sony WF-1000XM4 的场景、功能、竞争优势与目标用户建立“个人声音泡泡”的产品叙事。', role:'产品研究 / 视觉演示', evidence:'演示文稿 PPT 已上传', time:'2025.12.18', learned:'练习将产品功能、使用场景和目标用户转译为有说服力的视觉展示。', outcome:'完成 Sony WF-1000XM4 的产品视觉演示与叙事提案。' },
]
...
const proofItems = [
  ...
  ['03', 'AWARD', '走进大湾区品读 AIGC', '校内优秀奖', '获奖名单已收录于案例页'],
...
const virtualCollections = [
  ...
  { id:'04', title:'机械降神 / DEUS EX MACHINA', note:'在科技之下，科技的产物、机械造出的“神”降临：它究竟仍是神，还是另一种等待被命名的存在？', files: ['deus-ex-machina-01.jpg', 'deus-ex-machina-02.jpg'] },
...
function ProfilePage() { return <main className="detail-page profile-page"><header><a className="brand" href="#top">J.Z</a><PageBack /></header><section className="profile-page__hero"><section className="detail-hero"><p>( WHO I AM )</p><h1>JIAN<br /><em>ZHUOFAN.</em></h1><span>VISUAL STORYTELLER / CROSS-CULTURAL OBSERVER / PROJECT LEADER</span></section></section><section className="detail-grid"><div><b>BACKGROUND</b><p>广东工商职业技术大学 · 应用英语专业本科生<br />预计 2027 年毕业</p></div><div><b>MY PRACTICE</b><p>我是一名游走于影像创作、视觉设计、跨文化传播与商业思考之间的青年创作者。我关注人物、虚拟身份、女性经验和异文化生活；先观察人与环境之间的关系，再将它们转化为可被看见、理解和传播的视觉作品。</p></div><div><b>WHAT I WANT TO DO</b><p>我希望继续探索艺术与商业之间的可能性：让视觉不止表达自我，也能够创造交流、影响与价值。申请方向包括艺术、创意媒体、传播、文化管理及艺术与商业交叉专业。</p></div></section></main> }
function ContactPage() { return <main className="detail-page contact-page"><header><a className="brand" href="#top">J.Z</a><a className="page-back" href="#top">← BACK TO HOME</a></header><section className="contact-page__main"><p>( CONTACT )</p><h1>LET'S<br /><em>TALK.</em></h1><div><a href="mailto:kufengchun@gmail.com"><HoverBounceText text="kufengchun@gmail.com" /></a><a href="https://www.instagram.com/kufengchun8/" target="_blank" rel="noreferrer">INSTAGRAM / kufengchun8 <Arrow /></a><a href="https://www.facebook.com/kufengchun1" target="_blank" rel="noreferrer">FACEBOOK / kufengchun1 <Arrow /></a><a href="https://x.com/kufengchun1" target="_blank" rel="noreferrer">X / kufengchun1 <Arrow /></a></div></section></main> }
...
const virtualIdentityCases = [
  ...
  { no:'03', label:'CHRISTMAS COMMISSION / 客单', meta:'2025.12.25 · CLIENT COMMISSION', image:'/assets/virtual-identities/client-christmas.jpg', link:'#case/virtual', alt:'圣诞主题虚拟摄影客单' },
]
const personalIdentityCases = [
  { no:'02', label:'非人 / NON-HUMAN', meta:'2025.11.10 · 46 LIKES / 13 COMMENTS', image:'/assets/virtual-identities/personal-nonhuman.jpg', link:'#case/virtual', alt:'非人，个人虚拟摄影创作' },
  { no:'03', label:'熔金 / MOLTEN GOLD', meta:'2025.05.31 · 55 LIKES / 27 COMMENTS / 1 SAVE', image:'/assets/virtual-identities/personal-molten-gold.jpg', link:'#case/virtual', alt:'熔金，个人虚拟摄影创作' },
  { no:'04', label:'星月夜 / MOON NIGHT', meta:'2025.10.26 · 55 LIKES / 16 COMMENTS / 1 SAVE', image:'/assets/virtual-identities/personal-moon-night.jpg', link:'#case/virtual', alt:'星月夜，个人虚拟摄影创作' },
  { no:'05', label:'蝴蝶 / BUTTERFLY', meta:'2025.12.29 · 53 LIKES / 20 COMMENTS / 1 SAVE', image:'/assets/virtual-identities/personal-butterfly.jpg', link:'#case/virtual', alt:'蝴蝶，个人虚拟摄影创作' },
  { no:'06', label:'MACHINE DOLL', meta:'2025.05.10 · 33 LIKES / 18 COMMENTS / 1 SAVE', image:'/assets/virtual-identities/personal-machine-doll.jpg', link:'#case/virtual', alt:'Machine Doll，个人虚拟摄影创作' },
  { no:'01', label:'SALUTE / 个人创作', meta:'2025.05.23 · 195 LIKES / 19 COMMENTS / 1 SAVE', image:'/assets/virtual-identities/personal-salute.jpg', link:'#case/virtual', alt:'SALUTE TO CHRISTIAN DIOR 个人创作' },
]
function VirtualIdentitiesCase({ project }) { return <main className="detail-page virtual-identities-page"><header><a className="brand" href="#top">J.Z</a><PageBack /></header><section className={`case-cover ${project.className}`}><span>{project.no}</span><h1>{project.title}</h1><p>{project.type}</p></section><section className="identity-intro"><p>( CLIENT PUBLICATIONS / DATA )</p><h2>IDENTITY IS<br /><em>ALWAYS IN MOTION.</em></h2><span>将客户公开发表的图像与反馈，整理为持续增长的虚拟身份档案。</span></section><AccordionGallery items={virtualIdentityCases} defaultIndex={0} /><section className="identity-intro identity-intro--personal"><p>( PERSONAL CREATIONS )</p><h2>MADE FOR<br /><em>MY OWN WORLD.</em></h2><span>不以委托为终点，而以个人视觉语言继续展开的创作档案。</span></section><AccordionGallery items={personalIdentityCases} defaultIndex={0} /><section className="case-detail"><div><b>PROJECT OVERVIEW</b><p>{project.note}</p></div><div><b>WHAT I DID</b><p>{project.role}</p></div><div><b>OUTCOME / EVIDENCE</b><p>{project.outcome}<br /><br />{project.evidence}</p></div></section></main> }
function RootedFuturesCase({ project }) { const chapters = [['01','ART, DESIGN & RURAL REVITALISATION','参与“艺术设计与乡村振兴”相关项目，在地方文化、设计介入与社会更新的语境中学习研究与协作。','杰出营员 / 项目证书 / 寒假社会实践证明'],['02','COMMUNICATION IN THE AI ERA','参与“人工智能时代的传播变革”项目，并以论文形式完成结课作业；论文尚未发表，已进行知网查重。','研究写作 / 课程论文 / 知网查重'],['03','SRI LANKA NGO ONLINE TEACHING','参与斯里兰卡 NGO 线上支教，完成线上课程录制、PPT 制作与教学协作。','International Volunteer Certificate / 跨文化学习结业证书 / PPT 制作 / 网课录制']]; return <main className="detail-page rooted-page"><header><a className="brand" href="#top">J.Z</a><PageBack /></header><section className="rooted-cover"><span>07 / RESEARCH · EDUCATION · FIELD</span><h1>ROOTED<br /><em>FUTURES.</em></h1><p>From rural imagination to AI-era communication, and across-border education.</p><i aria-hidden="true" /></section><section className="rooted-manifesto"><p>( A BIG CASE WITH SMALL MOVEMENTS )</p><h2>LEARNING IS NOT<br />A QUIET <em>THING.</em></h2><span>我把证书、论文、课程与协作经验视为仍在生长的过程档案，而不是静止的履历。</span></section><section className="rooted-chapters">{chapters.map(([no,title,text,proof]) => <article key={no}><span>{no}</span><h3>{title}</h3><p>{text}</p><b>{proof}</b><i aria-hidden="true" /></article>)}</section><section className="case-detail"><div><b>PROJECT OVERVIEW</b><p>{project.note}</p></div><div><b>WHAT I DID</b><p>{project.role}</p></div><div><b>WHAT I LEARNED</b><p>{project.learned}</p></div><div><b>OUTCOME / EVIDENCE</b><p>{project.outcome}<br /><br />{project.evidence}</p></div></section></main> }

const shokzSlides = Array.from({ length: 10 }, (_, index) => `/assets/shokz/shokz-research/slide-${index + 1}.png`)
function ShokzSlideDeck() { const [page, setPage] = useState(0); const previous = () => setPage(index => (index - 1 + shokzSlides.length) % shokzSlides.length); const next = () => setPage(index => (index + 1) % shokzSlides.length); return <section className="case-material shokz-deck"><div className="shokz-deck__intro"><div><b>SHOKZ / JAPAN MARKET RESEARCH</b><p>翻页查阅国际市场营销课程期末展示：日本市场文化适配、成功案例、财报资料与本土化传播策略。</p></div><a href="/assets/shokz/shokz-research.pptx">DOWNLOAD ORIGINAL PPTX <Arrow /></a></div><div className="shokz-deck__viewer"><button type="button" onClick={previous} aria-label="上一页">← PREV</button><figure><img src={shokzSlides[page]} alt={`SHOKZ IN JAPAN 演示文稿第 ${page + 1} 页`} /><figcaption>{String(page + 1).padStart(2, '0')} / {String(shokzSlides.length).padStart(2, '0')}</figcaption></figure><button type="button" onClick={next} aria-label="下一页">NEXT →</button></div></section> }
function CasePage({ project }) {
  ...
  const material = project.id === 'shokz-japan' ? <ShokzSlideDeck /> : project.id === 'sony-bubble' ? <section className="case-material case-material--sony"><div><b>SONY WF-1000XM4 / PERSONAL SOUND BUBBLE</b><p>产品视觉演示：从通勤、工作与旅行场景切入，建立“个人声音泡泡”的产品叙事。</p><a href="/assets/sony/sony-presentation.pdf" target="_blank" rel="noreferrer">OPEN ORIGINAL PRESENTATION PDF <Arrow /></a></div><object data="/assets/sony/sony-presentation.pdf#page=1&view=FitH" type="application/pdf" aria-label="Sony 演示文稿 PDF 预览" /></section> : project.id === 'gbaa' ? <section className="case-material case-material--gbaa"><video controls preload="metadata" poster="/assets/gbaa/award-list.jpg"><source src="/assets/gbaa/cultural-video.mp4" type="video/mp4" /></video><div><b>AWARD / CAMPUS CULTURAL VIDEO COMPETITION</b><p>作品《走进大湾区品读 AIGC》获校内优秀奖。下方为获奖名单原图。</p><img src="/assets/gbaa/award-list.jpg" alt="校内获奖名单" /></div></section> : null
  const coverMaterial = project.id === 'shokz-japan' ? <section className="case-video case-video--shokz"><img src={shokzSlides[0]} alt="SHOKZ IN JAPAN PPT 首页"/><div>PROJECT MATERIAL<br /><small>FLIP THROUGH THE PRESENTATION ↓</small></div></section> : project.id === 'gbaa' ? <section className="case-video"><a href="/assets/gbaa/cultural-video.mp4" target="_blank" rel="noreferrer">WATCH PROJECT VIDEO <Arrow /></a></section> : <section className="case-video"><div>PROJECT MATERIAL<br /><small>[ 上传视频、演示稿或项目封面 ]</small></div></section>
  return <main className="detail-page"><header><a className="brand" href="#top">J.Z</a><PageBack /></header><section className={`case-cover ${project.className}`}><span>{project.no}</span><h1>{project.title}</h1><p>{project.type}</p></section>{project.url ? <BilibiliEmbed project={project} /> : coverMaterial}{material}<section className="case-detail"><div><b>PROJECT OVERVIEW</b><p>{project.note}</p></div><div><b>WHEN / CONTEXT</b><p>{project.time}</p></div><div><b>WHAT I DID</b><p>{project.role}</p></div><div><b>WHAT I LEARNED</b><p>{project.learned}</p></div><div><b>OUTCOME / EVIDENCE</b><p>{project.outcome}<br /><br />{project.evidence}</p></div></section></main>
}

function VideoEditingHub() { return <main className="detail-page video-editing-page"><header><a className="brand" href="#top">J.Z</a><PageBack /></header><section className="case-cover project--paper"><span>02</span><h1>VIDEO EDITING<br /><em>&amp; PRODUCTION.</em></h1><p>TWO-FILM CASE ARCHIVE</p></section><section className="video-editing-page__intro"><p>( SELECT A CASE )</p><h2>RESEARCH<br />BECOMES <em>MOVING IMAGE.</em></h2><span>从议题研究、团队统筹到影像剪辑与发布，两个项目被收束为同一组制作档案。</span></section><nav className="video-editing-page__links" aria-label="影片案例选择">{videoCaseStudies.map(project => <a href={`#case/video/${project.id}`} key={project.id}><span>{project.no}</span><div><h2>{project.title}</h2><p>{project.type}</p></div><b>OPEN CASE ↗</b></a>)}</nav></main> }
function ProductMarketingHub() { return <main className="detail-page video-editing-page product-marketing-page"><header><a className="brand" href="#top">J.Z</a><PageBack /></header><section className="case-cover project--paper"><span>04</span><h1>PRODUCT &amp;<br /><em>MARKETING RESEARCH.</em></h1><p>TWO-CASE PRODUCT ARCHIVE</p></section><section className="video-editing-page__intro"><p>( SELECT A CASE )</p><h2>DATA,<br />CULTURE <em>&amp; PRODUCT.</em></h2><span>从国际市场策略到个人声音场景，两项课程研究将资料、洞察与视觉表达编织为同一组产品档案。</span></section><nav className="video-editing-page__links" aria-label="产品与营销案例选择">{productCaseStudies.map(project => <a href={`#case/product/${project.id}`} key={project.id}><span>{project.no}</span><div><h2>{project.title}</h2><p>{project.type}</p></div><b>OPEN CASE ↗</b></a>)}</nav></main> }
...
function DeusExMachinaPage({ collection }) { const [lens, setLens] = useState({ x: 50, y: 50, active: false }); const moveLens = event => { const rect = event.currentTarget.getBoundingClientRect(); setLens({ x: ((event.clientX - rect.left) / rect.width) * 100, y: ((event.clientY - rect.top) / rect.height) * 100, active: true }) }; return <main className="detail-page artwork-page deus-page"><Waves className="deus-page__waves waves-canvas--fixed" lineColor="#c8ff3f" backgroundColor="#6628ce" waveSpeedX={.1} waveSpeedY={.065} waveAmpX={100} waveAmpY={90} friction={.63} tension={.025} maxCursorMove={210} xGap={18} yGap={42} /><header><a className="brand" href="#top">J.Z</a><a className="page-back" href="#gallery/virtual-photography">← BACK TO VIRTUAL PHOTOGRAPHY</a></header><section className="gallery-head"><p>( VIRTUAL PHOTOGRAPHY / SERIES 04 )</p><h1>{collection.title}</h1><span>{collection.note}</span></section><section className="deus-exhibition" onPointerMove={moveLens} onPointerLeave={() => setLens(state => ({ ...state, active: false }))}><i className="deus-exhibition__glass" aria-hidden="true" style={{ '--lens-x': `${lens.x}%`, '--lens-y': `${lens.y}%`, opacity: lens.active ? 1 : 0 }} />{collection.files.map((file, index) => <figure className="deus-exhibition__work" style={{ '--deus-index': index }} key={file}><span>{String(index + 1).padStart(2, '0')}</span><img loading={index === 0 ? 'eager' : 'lazy'} src={`/assets/virtual/${file}`} alt={`${collection.title} 组图 ${index + 1}`} /><figcaption>{index === 0 ? 'THE MACHINE MAKES A GOD' : 'WHAT DOES IT OBEY?'}</figcaption></figure>)}</section><section className="artwork-text"><p>DEUS EX MACHINA / 04</p><h1>机械降神</h1><div><b>WORK INTRODUCTION</b><p>在科技之下，机械制造的神明从程序、材质与光影中降临。</p></div><div><b>SPIRIT / READING</b><p>它拥有神性的外观，却又受制于算法、数据与人的欲望：它仍是神，还是一种等待被命名的新存在？</p></div></section></main> }

function SeriesPage({ collection }) {
  if (collection.id === '05') return <ErosionPage collection={collection} />
  if (collection.id === '04') return <DeusExMachinaPage collection={collection} />
...
function App() {
  ...
  const videoCaseId = route.replace('#case/video/', '')
  const activeVideoCase = videoCaseStudies.find((project) => project.id === videoCaseId)
  const productCaseId = route.replace('#case/product/', '')
  const activeProductCase = productCaseStudies.find((project) => project.id === productCaseId)
  ...
  if (route === '#case/feminism') return <><VideoEditingHub /><SiteCursor cursor={cursor} overHero={false} active={overImage} /></>
  if (activeVideoCase) return <><CasePage project={activeVideoCase} /><SiteCursor cursor={cursor} overHero={false} active={overImage} /></>
  if (route === '#case/shokz') return <><ProductMarketingHub /><SiteCursor cursor={cursor} overHero={false} active={overImage} /></>
  if (activeProductCase) return <><CasePage project={activeProductCase} /><SiteCursor cursor={cursor} overHero={false} active={overImage} /></>
  ...
  return <main className={loaded ? 'site is-ready' : 'site'} style={{ '--hero-progress': heroProgress, '--acid-opacity': .17 * (1 - heroProgress), '--hero-fade': 1 - heroProgress }}>
    <section className={isRushing ? 'hero hero--mountain is-rushing' : 'hero hero--mountain'} id="top" onPointerEnter={() => setOverHero(true)} onPointerLeave={() => { setOverHero(false); setIsRushing(false) }} onPointerDown={() => setIsRushing(true)} onPointerUp={() => setIsRushing(false)} onPointerCancel={() => setIsRushing(false)}>
      ...
      <div className="hero__body page-width">
        <a className="hero__eyebrow" href="#about-profile">JIAN ZHUOFAN / VISUAL STORYTELLER / CHINA</a>
