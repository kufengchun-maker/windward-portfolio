...
const virtualIdentityCases = [
  ...
  { no:'03', label:'闪亮圣诞装 / CHRISTMAS COMMISSION', meta:'2025.12.25 · 49 LIKES / 24 COMMENTS / 0 SAVES', image:'/assets/virtual-identities/christmas-client.jpg', link:'#case/virtual', alt:'闪亮圣诞装，客户公开发表图片与数据' },
]
