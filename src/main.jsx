...
function PixelPortrait() { const canvas = useRef(null); useEffect(() => { const target = canvas.current; const image = new Image(); image.src = '/assets/profile/jian-zhuofan-source.jpg'; image.onload = () => { const context = target.getContext('2d'); const width = target.width, height = target.height, scale = Math.max(width / image.width, height / image.height), drawWidth = image.width * scale, drawHeight = image.height * scale; context.imageSmoothingEnabled = false; context.fillStyle = '#0b1718'; context.fillRect(0, 0, width, height); context.drawImage(image, (width - drawWidth) / 2, (height - drawHeight) / 2, drawWidth, drawHeight) }; }, []); return <figure className="profile-pixel-portrait" aria-label="简卓凡的像素化人物肖像"><div className="profile-pixel-portrait__frame"><canvas ref={canvas} width="76" height="96" aria-label="简卓凡的像素化人物肖像" /><i /><i /></div><figcaption>01 / PIXEL SELF-PORTRAIT<br />OBSERVE · REFRAME · TELL</figcaption></figure> }

function ProfilePage() { return <main className="detail-page profile-page"><header><a className="brand" href="#top">J.Z</a><PageBack /></header><section className="profile-page__hero"><section className="detail-hero"><p>( WHO I AM )</p><h1>JIAN<br /><em>ZHUOFAN.</em></h1><span>VISUAL STORYTELLER / CROSS-CULTURAL OBSERVER / PROJECT LEADER</span></section><figure className="profile-pixel-portrait" aria-label="简卓凡的像素化人物肖像"><div className="profile-pixel-portrait__frame"><img src="/assets/profile/jian-zhuofan-pixel-portrait.png" alt="简卓凡的像素化人物肖像" /><i /><i /><i /></div><figcaption>01 / PIXEL SELF-PORTRAIT<br />OBSERVE · REFRAME · TELL</figcaption></figure></section><section className="detail-grid"><div><b>BACKGROUND</b><p>广东工商职业技术大学 · 应用英语专业本科生<br />预计 2027 年毕业</p></div><div><b>MY PRACTICE</b><p>我是一名游走于影像创作、视觉设计、跨文化传播与商业思考之间的青年创作者。我关注人物、虚拟身份、女性经验和异文化生活；先观察人与环境之间的关系，再将它们转化为可被看见、理解和传播的视觉作品。</p></div><div><b>WHAT I WANT TO DO</b><p>我希望继续探索艺术与商业之间的可能性：让视觉不止表达自我，也能够创造交流、影响与价值。申请方向包括艺术、创意媒体、传播、文化管理及艺术与商业交叉专业。</p></div></section></main> }
